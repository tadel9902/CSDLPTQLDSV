...
namespace QLDSV_TC
{
    static class Program
    {
        ...
        public static String constr_publisher = @"Data Source=ADMINISTRATOR\MSSQLSERVER3; Initial Catalog=QLDSV_TC; Integrated Security=true";

        public static SqlDataReader myReader;
        public static String servername = "ADMINISTRATOR\\MSSQLSERVER3";
        ...
        public static int KetNoiWindowsAuth(Boolean isShow = true)
        {
            if (Program.connstr != null && Program.conn.State == ConnectionState.Open)
                Program.conn.Close();
            try
            {
                // IMPORTANT: dùng Program.servername (được set từ combobox)
                connstr = "Data Source=" + Program.servername + ";Initial Catalog=" +
                           Program.database + ";Integrated Security=true";
            ...
            {
                if (isShow) XtraMessageBox.Show("Lỗi kết nối database\n" + e.Message, "Lỗi đăng nhập", MessageBoxButtons.OK);
                return 0;
            }
        }
