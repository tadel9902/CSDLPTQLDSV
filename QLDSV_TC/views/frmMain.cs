...
namespace QLDSV_TC.views
{
    public partial class frmMain : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        public frmMain()
        {
            ...
            MessageBox.Show($"Username: {Program.username}\nGroup: {Program.mGroup}\nHo Ten: {Program.mHoten}", "Thông tin");
            if (Program.username.Equals("PKT01", StringComparison.OrdinalIgnoreCase))
            {
                Program.mGroup = "PKT";
            }
            ...
            {
                // Giáo viên có quyền quản lý và báo cáo
                ribbonPageQuanLy.Visible = true;
                ribbonPageSinhVien.Visible = false; // Ẩn menu sinh viên
                ribbonPageBaoCao.Visible = true;
                ribbonPage5.Visible = true; // Cấu hình

                // Hiển thị ribbon groups cho giáo viên
                ribbonQuanLyKhoa_PGV.Visible = true;
                ribbonQuanLyKhoa_PGV.Enabled = true;
                reportPagePGV_Khoa.Visible = true;
                reportPagePGV_Khoa.Enabled = true;
            ...
            else if (Program.mGroup.Equals("db_owner") || Program.mGroup.Equals("ADMIN") || Program.username.Equals("dbo"))
            {
                // Admin có quyền truy cập menu quản lý và báo cáo, nhưng không phải menu sinh viên
                // Hiển thị ribbon pages cho admin
                ribbonPageQuanLy.Visible = true;
                ribbonPageSinhVien.Visible = false; // Ẩn menu sinh viên cho admin
                ribbonPageBaoCao.Visible = true;
                ribbonPage5.Visible = true; // Cấu hình

                // Hiển thị tất cả ribbon groups
                ribbonQuanLyKhoa_PGV.Visible = true;
                ribbonQuanLyKhoa_PGV.Enabled = true;
                ribbonQuanLyPKT.Visible = true;
                ribbonQuanLyPKT.Enabled = true;
                ...
                barBtnTaoLogin.Enabled = true;
                barBtnTaoLogin.Visibility = BarItemVisibility.Always;

                ribbon.SelectedPage = ribbonPageQuanLy;
            }
            else
            {
                // Default: Hiển thị tất cả menu nếu không match role nào
                ribbonPageQuanLy.Visible = true;
                ribbonPageSinhVien.Visible = true;
                ribbonPageBaoCao.Visible = true;
                ...
                MessageBox.Show($"Role '{Program.mGroup}' không được nhận diện. Hiển thị tất cả menu.", "Warning");
            }
        }
