...
namespace QLDSV_TC.views
{
    public partial class frmXemDiem : DevExpress.XtraEditors.XtraForm
    {
        public frmXemDiem()
        {
            ...
            // Kiểm tra nếu không phải sinh viên thì không load dữ liệu
            ...
            {
                // Nếu là admin hoặc role khác, hiển thị thông báo
                MessageBox.Show("Chức năng này chỉ dành cho sinh viên. Vui lòng đăng nhập bằng tài khoản sinh viên.", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
                this.Close();
            }
        }
